<template>
  <div>
      ...
      <div class="table-result row">
        ...
        <div v-for="filename, index in data" class="files-card" v-if="(index >= 0 && displayIndexAdder === 0 && index < totalDisplay) || (index < ((displayIndexAdder + 1) * totalDisplay) && index >= (displayIndexAdder * totalDisplay) && displayIndexAdder > 0)" data-hover="tooltip" data-plaement="top" v-bind:title="data[index].url">
          <div>
          <span class="card-settings"><i class="pull left fa fa-eye" @click="redirect('/resources_viewer/' + filename.code)" data-hover="tooltip" data-placement="top" title="Viewers"></i>
            <i class="settings fa fa-ellipsis-h" data-hover="tooltip" data-placement="top" title="Set Privacy" @click="showPrivacySettings(index)"></i></span>
            <select v-show="filename.privacyOption === true" v-model="filename.status" v-on:change="filename.privacyOption = false, updatePrivacy(filename.status, filename.id)">
          ...
          <div class="card-container" @click="this.window.open(data[index].url,'_blank')" target="_blank">
            <div class="center-area">
              <i v-bind:class="filename.type"></i>
            </div>
          </div>
          ...
          <div class="modal-body">
            <div class="input-group">
              ...
              <select class="form-control" v-model="type" placeholder="File Type">
                ...
                <option value="far fa-file-excel">Excel</option>
                <option value="far fa-file-powerpoint">Powerpoint</option>
                <option value="fab fa-youtube">Youtube</option>
                <option value="fa fa-files-o">Web Source</option>
              </select>
            </div>
            <div class="input-group">
...
export default {
  ...
  methods: {
    ...
    showPrivacySettings(index){
      this.data[index].privacyOption = true
    }
  }
}
</script>
